...
class CartController {
    ...
    static async addItem(req, res) {
        ...
        try {
            ...
            const cartItem = await CartService.addItem({ userId, productId, quantity }); //values passed as object
    ...
    static async updateItem(req, res) {
        try {
            ...
            const { cartItemId } = req.params; //url through [to fetch id]
            ...
            // Call the `updateItem` service method, passing the necessary data.    //variable      //value
            const updatedItem = await CartService.updateItem({ userId, cartItemId, newQuantity: quantity }); //values are passed as object
